...
public class SentencesLexicalEntry   {
  ...
  **/
  @ApiModelProperty(example = "null", value = "A linguistic category of words (or more precisely lexical items), generally defined by the syntactic or morphological behaviour of the lexical item in question, such as noun or verb")
   ...
   * @return sentences
  **/
  @ApiModelProperty(example = "null", required = true, value = "A list of examples of use sentences")

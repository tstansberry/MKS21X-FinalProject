...
public class VariantFormsListInner   {
  ...
  public VariantFormsListInner regions(Arrayofstrings regions) {
   ...
   * @return regions
  **/
  @ApiModelProperty(example = "null", value = "A particular area in which the variant form occurs, e.g. 'Great Britain'")

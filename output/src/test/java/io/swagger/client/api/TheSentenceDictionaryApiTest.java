...
public class TheSentenceDictionaryApiTest {
    ...
    private final TheSentenceDictionaryApi api = new TheSentenceDictionaryApi();
     ...
     */
    @Test
    public void entriesSourceLanguageWordIdSentencesGetTest() throws ApiException {
        String sourceLanguage = null;
        String wordId = null;
        String appId = null;
        String appKey = null;
        // SentencesResults response = api.entriesSourceLanguageWordIdSentencesGet(sourceLanguage, wordId, appId, appKey);
